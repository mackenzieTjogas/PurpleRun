...
API demonstrations | Macbook, HP Pavilion | Atom, Github, Chrome, Safari
Display activities on the homepage | Macbook | Atom, Github, Chrome, Safari, Heroku, Node.js
Populating activity information on the homepage | Macbook, Hp Pavilion | Atom, Github, Chrome, Safari
Account creation page and login page | Frontend | Atom, Github, Chrome, Safari, Heroku, Node.js
Database creation | Macbook, HP Pavilion | Atom, Github, Chrome, Safari, Node.js, PostgreSQL, Sequelize.js
Populate saved activities page from database| Macbook, HP Pavilion | Atom, Github, Chrome, Safari, Node.js, PostgreSQL, Sequelize.js
Login retrieves account information | Macbook, HP Pavilion | Atom, Github, Chrome, Safari, Node.js, PostgreSQL, Sequelize.js
Display users saved activities  | Macbook | Atom, Github, Chrome, Safari, Heroku, Node.js
Display selected activity  | Macbook | Atom, Github, Chrome, Safari, Heroku, Node.js

  Task                           | Hardware      | Software
  ------------------------------ | ------------- | -----------
  Mockups                        | ✓             | ✓
  API implementation             | ✓             | ✓
  Passwords: firs-time users     | ✓             | ✓
  Populate pages with info       |               |
